...
namespace UniFox {
    class UF_API MouseMovedEvent : public Event {
    public:
    ...
    class UF_API MouseScrolledEvent : public Event {
    public:
    ...
    class UF_API MouseButtonEvent : public Event {
    public:
    ...
    class UF_API MouseButtonPressedEvent : public MouseButtonEvent {
    public:
