...
namespace UniFox {
    OpenGLShader::OpenGLShader(const std::string& vertexSrc, const std::string fragmentSrc) {
        ...
        if(isCompiled == GL_FALSE)
        {
            ...
            UF_CORE_ASSERT(false, "Vertex shader compilation failure!")
            return;
        }
        ...
        if (isCompiled == GL_FALSE)
        {
            ...
            UF_CORE_ERROR("{0}", infoLog.data());
            UF_CORE_ASSERT(false, "Fragment shader compilation failure!");
            return;
        }
    ...
    void OpenGLShader::UploadUniformFloat (const std::string& name, const glm::vec1& vector) const {
