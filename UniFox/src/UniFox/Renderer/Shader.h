...
namespace UniFox {
    ...
    public:
        ...
        virtual void SetIntV(const std::string& name, const int* values, const int count) = 0;
    ...
    public:
        ...
        Ref<Shader> Load(const std::string& filepath); // name = filename without extension
